...
static const key_definition_t keymaps[MAX_LAYERS][MATRIX_ROW][MATRIX_COL] = {
    ...
    //                  L1/TAB  GUI/SPC
    [0] = {
        {NORM_KEY(KC_EQUAL),    NORM_KEY(KC_1),     NORM_KEY(KC_2),     NORM_KEY(KC_3),     NORM_KEY(KC_4),           NORM_KEY(KC_5)},
        {NORM_KEY(KC_ESC),      NORM_KEY(KC_Q),     NORM_KEY(KC_W),     NORM_KEY(KC_E),     NORM_KEY(KC_R),           NORM_KEY(KC_T)},
        {MOD_KEY(KC_LCTRL),     NORM_KEY(KC_A),     NORM_KEY(KC_S),     NORM_KEY(KC_D),     NORM_KEY(KC_F),           NORM_KEY(KC_G)},
        {MOD_KEY(KC_LALT),      NORM_KEY(KC_Z),     NORM_KEY(KC_X),     NORM_KEY(KC_C),     NORM_KEY(KC_V),           NORM_KEY(KC_B)},
        {NORM_KEY(KC_NO),       NORM_KEY(KC_NO),    NORM_KEY(KC_NO),    NORM_KEY(KC_NO),    LT_TO(1, KC_TAB, 100),    MT_TO(KC_LGUI, KC_SPACE, 130)}
    },
    #else
    ...
    [0] = {
        ...
        {NORM_KEY(KC_H),                    NORM_KEY(KC_J),             NORM_KEY(KC_K),     NORM_KEY(KC_L),     NORM_KEY(KC_SEMICOLON), LT(1, KC_QUOT)},
        {NORM_KEY(KC_N),                    NORM_KEY(KC_M),             NORM_KEY(KC_COMMA), NORM_KEY(KC_DOT),   NORM_KEY(KC_SLASH),     MOD_KEY(KC_LGUI)},
        {MT_TO(KC_RSHIFT, KC_ENTER, 130),   LT_TO(2, KC_BSPC, 100),     NORM_KEY(KC_NO),    NORM_KEY(KC_NO),    NORM_KEY(KC_NO),        NORM_KEY(KC_NO)}
    },
    #endif
    ...
    [1] = {
        ...
        {TRANS_KEY(),         NORM_KEY(KC_GRAVE),  SHIFT_KEY(KC_DOT),    SHIFT_KEY(KC_COMMA),   NORM_KEY(KC_MINUS),    SHIFT_KEY(KC_BSLASH)},
        {TRANS_KEY(),         SHIFT_KEY(KC_1),     SHIFT_KEY(KC_8),      NORM_KEY(KC_SLASH),    NORM_KEY(KC_EQUAL),    SHIFT_KEY(KC_7)},
        {TRANS_KEY(),         SHIFT_KEY(KC_GRAVE), SHIFT_KEY(KC_EQUAL),  NORM_KEY(KC_LBRC),     NORM_KEY(KC_RBRC),     SHIFT_KEY(KC_5)},
    ...
    [1] = {
        ...
        {SHIFT_KEY(KC_6),       SHIFT_KEY(KC_QUOT),         SHIFT_KEY(KC_SEMICOLON),    NORM_KEY(KC_SEMICOLON),     SHIFT_KEY(KC_MINUS),    TRANS_KEY()},
        {SHIFT_KEY(KC_4),       SHIFT_KEY(KC_9),            SHIFT_KEY(KC_LBRC),         NORM_KEY(KC_LBRC),          SHIFT_KEY(KC_2),        TRANS_KEY()},
        {SHIFT_KEY(KC_3),       SHIFT_KEY(KC_0),            SHIFT_KEY(KC_RBRC),         NORM_KEY(KC_RBRC),          NORM_KEY(KC_NONE),      NORM_KEY(KC_NONE)},
        {TRANS_KEY(),           NORM_KEY(KC_0),             NORM_KEY(KC_NO),            NORM_KEY(KC_NO),            NORM_KEY(KC_NO),        NORM_KEY(KC_NO)},
    },
    #endif
    ...
    [2] = {
        {TRANS_KEY(),         NORM_KEY(KC_F2),                  NORM_KEY(KC_F3),                NORM_KEY(KC_F4),                NORM_KEY(KC_F5),                NORM_KEY(KC_F6)},
        {TRANS_KEY(),         CONS_KEY(KC_BRIGHTNESS_UP),       CONS_KEY(KC_AUDIO_MUTE),        CONS_KEY(KC_AUDIO_VOL_DOWN),    CONS_KEY(KC_AUDIO_VOL_UP),      NORM_KEY(KC_NO)},
        {TRANS_KEY(),         CONS_KEY(KC_BRIGHTNESS_DOWN),     CONS_KEY(KC_MEDIA_PREV_TRACK),  CONS_KEY(KC_MEDIA_NEXT_TRACK),  CONS_KEY(KC_MEDIA_PLAY_PAUSE),  CONS_KEY(KC_MEDIA_STOP)},
        {TRANS_KEY(),         NORM_KEY(KC_NO),                  NORM_KEY(KC_NO),                NORM_KEY(KC_NO),                NORM_KEY(KC_NO),                NORM_KEY(KC_NO)},
        {NORM_KEY(KC_NO),     NORM_KEY(KC_NO),                  NORM_KEY(KC_NO),                TRANS_KEY(),                    TRANS_KEY(),                    TRANS_KEY()},
    },
    #else
    ...
    switch (key.type) {
        case KEY_TYPE_NORMAL:
            switch (key.keycode) {
                ...
                case KC_NO: return "None";
                case KC_TRNS: return "Transparent";
