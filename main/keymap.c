...
static const key_definition_t keymaps[MAX_LAYERS][MATRIX_ROW][MATRIX_COL] = {
    ...
    [0] = {
        {MT(KC_ESC, KC_EQUAL),  NORM_KEY(KC_1),     NORM_KEY(KC_2),     NORM_KEY(KC_3),     NORM_KEY(KC_4),     NORM_KEY(KC_5)},
        {NORM_KEY(KC_CAPS),     NORM_KEY(KC_Q),     NORM_KEY(KC_W),     NORM_KEY(KC_E),     NORM_KEY(KC_R),     NORM_KEY(KC_T)},
        {MT(KC_LSFT, KC_BSPC),  NORM_KEY(KC_A),     NORM_KEY(KC_S),     NORM_KEY(KC_D),     NORM_KEY(KC_F),     NORM_KEY(KC_G)},
        {MOD_KEY(KC_LGUI),      MT(KC_LALT, KC_Z),  NORM_KEY(KC_X),     NORM_KEY(KC_C),     NORM_KEY(KC_V),     NORM_KEY(KC_B)},
        {NORM_KEY(KC_NO),       NORM_KEY(KC_NO),    NORM_KEY(KC_NO),    NORM_KEY(KC_NO),    LT(2, KC_ENTER),    MT(KC_LCTRL, KC_TAB)}
    },
    #else
    ...
    [1] = {
        {NORM_KEY(KC_ESC),    NORM_KEY(KC_F1),     NORM_KEY(KC_F2),      NORM_KEY(KC_F3),     NORM_KEY(KC_F4),        NORM_KEY(KC_F5)},
        {NORM_KEY(KC_GRAVE),  SHIFT_KEY(KC_1),     SHIFT_KEY(KC_2),      SHIFT_KEY(KC_3),     SHIFT_KEY(KC_4),        SHIFT_KEY(KC_5)},     // ~ ! @ # $ %
        {TRANS_KEY(),         SHIFT_KEY(KC_6),     SHIFT_KEY(KC_7),      SHIFT_KEY(KC_8),     SHIFT_KEY(KC_9),        SHIFT_KEY(KC_0)},     // ^ & * ( )
    ...
    [1] = {
        ...
        {NORM_KEY(KC_7),    NORM_KEY(KC_8),       NORM_KEY(KC_9),     NORM_KEY(KC_KP_MINUS),  NORM_KEY(KC_KP_SLASH),    NORM_KEY(KC_F12)},
        {NORM_KEY(KC_4),    NORM_KEY(KC_5),       NORM_KEY(KC_6),     NORM_KEY(KC_KP_PLUS),   NORM_KEY(KC_KP_ASTERISK), NORM_KEY(KC_BSPC)},
        {NORM_KEY(KC_1),    NORM_KEY(KC_2),       NORM_KEY(KC_3),     NORM_KEY(KC_DOT),       NORM_KEY(KC_EQUAL),       NORM_KEY(KC_ENTER)},
    ...
    [2] = {
        {NORM_KEY(KC_ESC),    NORM_KEY(KC_F1),  NORM_KEY(KC_F2),                NORM_KEY(KC_F3),                NORM_KEY(KC_F4),                NORM_KEY(KC_F5)},
        {TRANS_KEY(),         TRANS_KEY(),      CONS_KEY(KC_AUDIO_MUTE),        CONS_KEY(KC_AUDIO_VOL_DOWN),    CONS_KEY(KC_AUDIO_VOL_UP),      NORM_KEY(KC_5)},
        {TRANS_KEY(),         TRANS_KEY(),      CONS_KEY(KC_MEDIA_PREV_TRACK),  CONS_KEY(KC_MEDIA_NEXT_TRACK),  CONS_KEY(KC_MEDIA_PLAY_PAUSE),  CONS_KEY(KC_MEDIA_STOP)},
    ...
    [2] = {
        {NORM_KEY(KC_F6),   NORM_KEY(KC_F7),        NORM_KEY(KC_F8),                NORM_KEY(KC_F9),                NORM_KEY(KC_F10),     NORM_KEY(KC_F11)},
        {NORM_KEY(KC_HOME), NORM_KEY(KC_UP),        NORM_KEY(KC_END),               NORM_KEY(KC_PGUP),              TRANS_KEY(),          NORM_KEY(KC_F12)},
        {NORM_KEY(KC_LEFT), NORM_KEY(KC_DOWN),      NORM_KEY(KC_RIGHT),             NORM_KEY(KC_PGDN),              TRANS_KEY(),          NORM_KEY(KC_DEL)},
        {TRANS_KEY(),       TRANS_KEY(),            TRANS_KEY(),                    TRANS_KEY(),                    TRANS_KEY(),          NORM_KEY(KC_INS)},
