...
static const key_def_t keymaps[MAX_LAYERS][MATRIX_ROW][MATRIX_COL] = {
#if !IS_MASTER
    // Layer 0 - Base layer Left Side (Homerow Mods: GACS)
    // =    1  2  3  4  5
    // TAB  Q  W  E  R  T
    // CTL  A  S  D  F  G
    //      Z  X  C  V  B
    ...
    //        N    M    ,    .    /    ESC
    // SHIFT/ENT   L2/BS
    [0] = {{NORM_KEY(KC_6), NORM_KEY(KC_7), NORM_KEY(KC_8), NORM_KEY(KC_9), NORM_KEY(KC_0), NORM_KEY(KC_MINUS)},
           {NORM_KEY(KC_Y), NORM_KEY(KC_U), NORM_KEY(KC_I), NORM_KEY(KC_O), NORM_KEY(KC_P), NORM_KEY(KC_BSLASH)},
           {NORM_KEY(KC_H), MT_TO(KC_RSHIFT, KC_J, 140), MT_TO(KC_RCTRL, KC_K, 150), MT_TO(KC_RALT, KC_L, 170), MT_TO(KC_RGUI, KC_SEMICOLON, 200), LT_TO(1, KC_QUOT, 180)},
           {NORM_KEY(KC_N), NORM_KEY(KC_M), NORM_KEY(KC_COMMA), NORM_KEY(KC_DOT), NORM_KEY(KC_SLASH), NORM_KEY(KC_ESC)},
           {MT_TO(KC_RSHIFT, KC_ENTER, 80), LT_TO(2, KC_BSPC, 100), NORM_KEY(KC_NO), NORM_KEY(KC_NO), NORM_KEY(KC_NO), NORM_KEY(KC_NO)}},
#endif
    ...
    [1] =
        {
            ...
            {SHIFT_KEY(KC_6), SHIFT_KEY(KC_QUOT), SHIFT_KEY(KC_SEMICOLON), NORM_KEY(KC_SEMICOLON), SHIFT_KEY(KC_MINUS), NORM_KEY(KC_BSLASH)},
            {SHIFT_KEY(KC_4), SHIFT_KEY(KC_9), SHIFT_KEY(KC_LBRC), NORM_KEY(KC_LBRC), SHIFT_KEY(KC_2), TRANS_KEY()},
            {SHIFT_KEY(KC_3), SHIFT_KEY(KC_0), SHIFT_KEY(KC_RBRC), NORM_KEY(KC_RBRC), NORM_KEY(KC_NO), TRANS_KEY()},
    ...
    [2] =
        {
            {TRANS_KEY(), NORM_KEY(KC_F2), NORM_KEY(KC_F3), NORM_KEY(KC_F4), NORM_KEY(KC_F5), NORM_KEY(KC_F6)},
            {TRANS_KEY(), CONS_KEY(KC_BRIGHTNESS_UP), CONS_KEY(KC_AUDIO_MUTE), CONS_KEY(KC_AUDIO_VOL_DOWN), CONS_KEY(KC_AUDIO_VOL_UP), NORM_KEY(KC_NO)}, {TRANS_KEY(), CONS_KEY(KC_BRIGHTNESS_DOWN), CONS_KEY(KC_MEDIA_PREV_TRACK), CONS_KEY(KC_MEDIA_NEXT_TRACK), CONS_KEY(KC_MEDIA_PLAY_PAUSE), CONS_KEY(KC_MEDIA_STOP)},
    ...
    [2] =
        {
            ...
            {NORM_KEY(KC_NO), NORM_KEY(KC_NO), NORM_KEY(KC_NO), NORM_KEY(KC_NO), NORM_KEY(KC_NO), TRANS_KEY()},
